...
from ssd.engine.DANN_trainer import do_train
from ssd.modeling.backbone import build_backbone
from ssd.modeling.box_head import build_box_head
from ssd.modeling.domain_discriminator import DomainDiscriminatorReverse
...
def train(cfg, args):
    ...
    domaindiscriminator = DomainDiscriminatorReverse()#域判别器
...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="configs/vgg_ssd300_voc0712_dann.yaml",
        metavar="FILE",
