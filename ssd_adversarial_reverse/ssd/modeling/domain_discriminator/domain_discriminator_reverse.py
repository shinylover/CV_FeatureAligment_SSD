...
class DomainDiscriminatorReverse(nn.Module):
    def __init__(self):
        super(DomainDiscriminatorReverse, self).__init__()

        self.layer1 = self._make_layer(512, 256, kernel_size=3, stride=3, padding=1)#[256,13,13] [通道数，长，宽]
